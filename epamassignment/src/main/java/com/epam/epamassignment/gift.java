...
public class gift {
	public static void main(String[] args)
	{
		...
		String s[]= {"snickers","kajubarfi","mottichuri","bounty"};
		int[] a = 1new int[4];
        char n1;
        sweets collect;
        Boolean n=true;
        ...
        while(n)
        {
        	...
        	case '2': System.out.println("Enter the quantity of kajubarfi: ");
			  qnt=sc.nextInt();
			  System.out.println("Enter the weight in grams: ");
			  wt=sc.nextInt();
        	...
        	case '3': System.out.println("Enter the quantity of mottichuri: ");
			  qnt=sc.nextInt();
			  System.out.println("Enter the weight in grams: ");
			  wt=sc.nextInt();
			  collect= new mottichuri();
			  total_weight=collect.totalwt( qnt, wt);
			  totalbox_wt=totalbox_wt+total_weight;
			  a[2]+=qnt*wt;
			  totwt=0;
